"""Dynamic plugin loader for advanced Pixi architecture.

This loader enables runtime extension of Pixi capabilities by discovering
...
class PluginLoader:
    ...
    def __init__(self, plugin_directory: str = "python/Pixi/plugins") -> None:
    ...
    def _module_name_from_path(path: Path) -> str:
        ...
        return f"Pixi_dynamic_plugin_{stem}"
