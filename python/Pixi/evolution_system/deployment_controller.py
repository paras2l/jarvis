...
from Pixi.evolution_system.sandbox_tester import SandboxResult
...
class DeploymentController:
    ...
    def __init__(
        ...
        workspace_root: str = ".",
        rollback_root: str = "python/.Pixi_runtime/evolution_rollbacks",
    ) -> None:
        self._memory = memory
    ...
    def _target_for_staged_path(self, staged_path: str) -> Path:
        ...
        return (self._workspace_root / "python" / "Pixi" / relative).resolve()
