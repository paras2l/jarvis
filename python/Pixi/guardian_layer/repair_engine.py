"""Repair engine for Pixi Guardian Layer.
...
from Pixi.guardian_layer.module_restart_manager import ModuleRestartManager
from Pixi.guardian_layer.rollback_controller import RollbackController
