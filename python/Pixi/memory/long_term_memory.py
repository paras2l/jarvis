...
class LongTermMemory:
    ...
    def __init__(self, storage_path: str | Path = "python/.Pixi_long_term_memory.jsonl") -> None:
...
def _example_long_term() -> None:
    memory = LongTermMemory(storage_path="python/.Pixi_long_term_memory.example.jsonl")

    memory.store(
        key="project:Pixi:vision",
        value={
    ...
    print("Fetch by key:")
    print(memory.fetch("project:Pixi:vision"))
