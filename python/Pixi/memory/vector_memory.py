"""Vector memory for Pixi semantic search.
...
class VectorMemory:
    ...
    def __init__(
        self,
        collection_name: str = "Pixi_memory",
        persist_directory: str = "python/.Pixi_chroma",
...
class SemanticKnowledgeBase:
    """Convenience wrapper combining write/read patterns for Pixi knowledge."""
...
def _example_vector_memory() -> None:
    vector_memory = VectorMemory(collection_name="Pixi_memory_example")

    vector_memory.add_text(
        doc_id="doc-1",
        text="Pixi planner converts high-level goals into executable task graphs.",
