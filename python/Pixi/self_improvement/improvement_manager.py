"""Improvement manager for Pixi self-improvement cycles."""
...
from Pixi.self_improvement.capability_gap_detector import CapabilityGapDetector, GapDetectionResult
from Pixi.self_improvement.learning_scheduler import LearningRunResult, LearningScheduler
from Pixi.self_improvement.performance_analyzer import PerformanceAnalyzer, PerformanceReport
from Pixi.self_improvement.tool_builder import BuildResult, ToolBuilder
...
class ImprovementManager:
    def __init__(
        ...
        runtime_error_log_path: str = "python/.Pixi_runtime/runtime_errors.log",
        runtime_action_log_path: str = "python/.Pixi_runtime/action_log.jsonl",
        manager_log_path: str = "python/.Pixi_runtime/self_improvement.log",
    ) -> None:
        self._memory = memory
    ...
    def _build_logger(path: str) -> logging.Logger:
        ...
        logger = logging.getLogger("Pixi.self_improvement")
