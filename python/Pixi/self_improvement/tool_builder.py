"""Tool builder for Pixi self-improvement."""
...
class ToolBuilder:
    def __init__(self, memory: MemorySystem, skill_registry: SkillRegistry, generated_dir: str = "python/Pixi/skills/generated") -> None:
        self._memory = memory
