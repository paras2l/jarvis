"""Working examples of Pixi Simulation Engine usage.
...
from Pixi.simulation_engine import (
    SimulationEngine,
    SimulationRequest,
    SimulationResult,
    SimulationStatus,
...
def example_3_risk_analysis():
    ...
    if result.get("risk_assessment"):
        ...
        if risk.get("critical_risks"):
            ...
            for critical_risk in risk["critical_risks"]:
                print(f"  â€¢ {critical_risk['risk_description']}")
    ...
    if confidence > 0.75:
        print("âœ“ Sufficient confidence to proceed with expansion")
    elif confidence > 0.50:
        print("âš  Moderate confidence - consider additional planning")
    else:
        print("âœ— Low confidence - recommend more research before proceeding")
...
def example_4_learning_from_history():
    ...
    print(f"  Average Prediction Error: Â±{avg_error:.1%}")
    ...
    # Contextual insights
    print(f"\nLearned Patterns:")
    print(f"  â€¢ Conservative strategies perform better in down markets (<0.5)")
    print(f"  â€¢ Aggressive strategies perform well with high sentiment (>0.7)")
    print(f"  â€¢ Best overall accuracy comes from sentiment-aligned decisions")
...
def example_5_reasoning_integration():
    ...
    print("  â€¢ Make informed decisions between alternatives")
    print("  â€¢ Explain decisions to stakeholders")
    print("  â€¢ Identify potential issues before they occur")
    print("  â€¢ Adjust strategy based on changing conditions")
...
def example_6_custom_scenarios():
    ...
    for num_scenarios in scenario_counts:
        ...
        print(f"  âœ“ Evaluated {num_scenarios} scenarios")
    ...
    print("  â€¢ Greater confidence in predictions")
    print("  â€¢ Better understanding of edge cases")
    print("  â€¢ Higher computational cost")
...
def main():
    ...
    print("â•‘                 Pixi Simulation Engine - Working Examples                    â•‘")
    ...
    try:
        ...
        print("\nNext Steps:")
        print("  â€¢ Review the test suite: test_simulation_engine.py")
        print("  â€¢ Read full documentation: docs/SIMULATION_ENGINE.md")
        print("  â€¢ Integrate with World Model and Reasoning Engine")
        print("  â€¢ Deploy to production with monitoring")
