"""Central communication hub for the Pixi AI architecture."""
...
from Pixi.contracts.api_contract import validate_transport_message_contract
...
from Pixi.system_bus.message_router import MessageRouter, RoutingReport
...
class SystemBus:
    """Communication backbone connecting Pixi subsystems."""
