"""Registry for generated Pixi tools."""
...
class ToolRegistry:
    ...
    def __init__(self, memory: MemorySystem | None = None, skill_registry: SkillRegistry | None = None, catalog_path: str = "python/.Pixi_runtime/tool_registry.json") -> None:
        self._memory = memory
    ...
    def _persist_snapshot(self) -> None:
        ...
        if self._memory is not None:
            ...
            self._memory.remember_long_term(
                ...
                value=payload,
                source="Pixi.tool_learning.tool_registry",
                importance=0.72,
                tags=["tool_learning", "registry"],
            )
