"""Validate generated Pixi tools before activation."""
...
from Pixi.tool_learning.tool_generator import GeneratedToolArtifact
...
class ToolValidator:
    ...
    def _persist(self, report: ToolValidationReport) -> None:
        ...
        self._memory.remember_long_term(
            ...
            value=payload,
            source="Pixi.tool_learning.tool_validator",
            importance=0.8,
            tags=["tool_learning", "validation"],
        )
