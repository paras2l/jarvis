"""Continuous cognitive loop for Jarvis.
...
from jarvis.stability_core.stability_core import SystemStabilityCore, StabilityCycleResult
...
class BrainLoopCore:
    ...
    def start(self) -> None:
        ...
        with self._lock:
            ...
            self._thread = threading.Thread(target=self._run_forever, name="jarvis-brain-loop", daemon=True)
            self._thread.start()
