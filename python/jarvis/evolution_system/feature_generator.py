...
from jarvis.evolution_system.improvement_planner import ImprovementPlan
...
class FeatureGenerator:
    ...
    def __init__(self, memory: MemorySystem, staging_root: str = "python/.jarvis_runtime/evolution_staging") -> None:
        self._memory = memory
        self._staging_root = Path(staging_root)
        self._staging_root.mkdir(parents=True, exist_ok=True)

    def generate(self, plans: Iterable[ImprovementPlan], *, author: str = "jarvis_evolution") -> GeneratedBundle:
    ...
    def _generate_for_plan(self, plan: ImprovementPlan, *, author: str) -> GeneratedFeature:
        ...
        for target in plan.target_files:
            ...
            relative = normalized_target.replace("python/jarvis/", "")
    ...
    def _is_core_file(target: str) -> bool:
        core_markers = [
            "python/jarvis/runtime/",
            "python/jarvis/core/",
            "python/jarvis/memory/",
            "python/jarvis/system_bus/",
            "python/jarvis/world_model/",
        ]
