...
from jarvis.evolution_system.capability_analyzer import CapabilityGap
...
class ImprovementPlanner:
    ...
    def _target_files(gap: CapabilityGap) -> List[str]:
        mapping = {
            "reliability": [
                "python/jarvis/extensions/reliability_guard.py",
                "python/jarvis/extensions/fallback_executor.py",
            ],
            "efficiency": [
                "python/jarvis/extensions/workflow_optimizer.py",
            ],
            "performance": [
                "python/jarvis/extensions/performance_optimizer.py",
                "python/jarvis/extensions/cache_layer.py",
            ],
            "resource_management": [
                "python/jarvis/extensions/resource_governor.py",
            ],
            "safety": [
                "python/jarvis/extensions/safety_auditor.py",
                "python/jarvis/extensions/decision_validator.py",
            ],
            "capability_coverage": [
                "python/jarvis/extensions/capability_bridge.py",
            ],
        }
        return list(mapping.get(gap.category, ["python/jarvis/extensions/generic_evolution_feature.py"]))
