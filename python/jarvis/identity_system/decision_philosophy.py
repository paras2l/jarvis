"""Decision philosophy for Jarvis identity system.
...
class DecisionPhilosophy:
    ...
    philosophy_name: str = "jarvis_foundational"
    version: str = "1.0.0"
    ...
    def from_mapping(cls, config: Mapping[str, Any]) -> "DecisionPhilosophy":
        ...
        return cls(
            philosophy_name=str(config.get("philosophy_name", "jarvis_foundational")),
