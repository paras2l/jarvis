...
if TYPE_CHECKING:
    ...
    from jarvis.knowledge_system.knowledge_graph import Entity, Relationship
...
class ReasoningKnowledgeBridge:
    ...
    def search_knowledge_for_reasoning(
        ...
        Integration point: Reasoning → Knowledge System
        """
    ...
    def learn_from_reasoning(self, reasoning_result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Integration point: Reasoning → Knowledge System (feedback)
        """
