"""Unified Memory System facade for Jarvis.
...
from jarvis.core.contracts import MemoryStore
from jarvis.memory.long_term_memory import LongTermMemory
from jarvis.memory.short_term_memory import ShortTermMemory
from jarvis.memory.vector_memory import VectorMemory, VectorSearchResult
...
def _example_memory_system() -> None:
    ...
    memory.remember_short_term(
        ...
        value={"goal": "Ship Jarvis memory layer", "status": "in_progress"},
        tags=["session", "planner"],
    )
    memory.remember_long_term(
        key="project:jarvis:principle",
