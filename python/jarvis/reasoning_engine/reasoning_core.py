"""Reasoning core coordinator for Jarvis.
...
from jarvis.reasoning_engine.constraint_analyzer import ConstraintAnalysisResult, ConstraintAnalyzer
from jarvis.reasoning_engine.decision_engine import ReasoningDecision, ReasoningDecisionEngine
from jarvis.reasoning_engine.goal_inference import GoalInferenceEngine, GoalInferenceResult
from jarvis.reasoning_engine.strategy_generator import StrategyGenerationResult, StrategyGenerator
from jarvis.system_bus.bus_core import SystemBus
from jarvis.world_model.world_state import WorldStateModel, WorldStateSnapshot
...
class ReasoningCore:
    """Central coordinator for Jarvis reasoning pipeline."""
