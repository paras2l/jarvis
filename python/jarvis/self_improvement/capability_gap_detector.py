"""Capability gap detector for Jarvis self-improvement."""
...
from jarvis.self_improvement.performance_analyzer import ErrorFrequencyRecord, PerformanceReport
        ...
        if report.success_rate < 0.6:
            return [
                self._mk(
                    ...
                    "Jarvis is failing a significant portion of runtime tasks.",
                    0.86,
                    0.88,
                    0.82,
