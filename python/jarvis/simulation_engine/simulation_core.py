...
Coordinates the simulation pipeline: world model data → scenarios → strategy simulation →
outcome prediction → risk analysis → results to reasoning engine.
"""
...
from jarvis.world_model.world_model import WorldState
...
class SimulationEngine:
    ...
    Integration points:
    - World Model Engine → context and world state
    - Knowledge System → entity/relationship context
    - Strategy Simulator → simulate strategies
    - Outcome Predictor → predict results
    - Risk Analyzer → evaluate uncertainty
    - Memory System → store results for learning
    - Reasoning Engine ← provide simulation results
    """
    ...
    def __init__(
        ...
        from jarvis.simulation_engine.scenario_generator import ScenarioGenerator
        from jarvis.simulation_engine.strategy_simulator import StrategySimulator
        from jarvis.simulation_engine.outcome_predictor import OutcomePredictor
        from jarvis.simulation_engine.risk_analyzer import RiskAnalyzer
        from jarvis.simulation_engine.simulation_memory import SimulationMemory
    ...
    def simulate(
        ...
        Integration point: World Model / Reasoning Engine → Simulation Engine
    ...
    def get_simulation_result(self, result_id: str) -> Optional[SimulationResult]:
        ...
        Integration point: Reasoning Engine ← Simulation results
        """
    ...
    def get_reasoning_context(self, simulation_result: SimulationResult) -> Dict[str, Any]:
        ...
        Integration point: Simulation Engine → Reasoning Engine
        """
        return {
    ...
    def compare_strategies(self, simulation_result: SimulationResult) -> List[Dict[str, Any]]:
        ...
        Integration point: Reasoning Engine → Strategy comparison
        """
        comparisons = []
    ...
    def get_diagnostics(self) -> Dict[str, Any]:
        ...
        Integration point: Self-Improvement → Simulation Engine health
        """
        return {
    ...
    def _persist_results(self, result: SimulationResult) -> None:
        ...
        Integration point: Simulation Engine → Memory System
        """
        if not self._memory:
            return
