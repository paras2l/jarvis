"""Generate new Jarvis tool implementations."""
...
from jarvis.tool_learning.tool_detector import ToolNeed
...
class ToolGenerator:
    ...
    def __init__(self, memory: MemorySystem, output_dir: str = "python/jarvis/tool_learning/generated", code_agent: Any | None = None) -> None:
        self._memory = memory
...
'''
    ...
    def _build_prompt(self, need: ToolNeed) -> str:
        return (
            f"Create a Jarvis tool named {need.tool_name}. "
    ...
    def _build_rewrite_prompt(self, artifact: GeneratedToolArtifact, *, prompt_hint: str | None = None) -> str:
        ...
        return f"Rewrite the Jarvis tool {artifact.tool_name} to improve robustness and clarity.{hint}"
    ...
    def _persist(self, artifact: GeneratedToolArtifact) -> None:
        ...
        self._memory.remember_long_term(
            ...
            value=payload,
            source="jarvis.tool_learning.tool_generator",
            importance=0.77,
            tags=["tool_learning", "generation"],
        )
