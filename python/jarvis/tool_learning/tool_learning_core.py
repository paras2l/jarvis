"""Tool learning orchestrator for Jarvis."""
...
from jarvis.agent_system.agent_core import AgentTool
...
from jarvis.tool_learning.tool_detector import ToolDetector, ToolNeed
...
class ToolLearningCore:
    ...
    def __init__(
        ...
        *,
        ...
        output_dir: str = "python/jarvis/tool_learning/generated",
    ) -> None:
        self._memory = memory
    ...
    def _persist(self, result: ToolLearningResult) -> None:
        ...
        self._memory.remember_long_term(
            ...
            value=payload,
            source="jarvis.tool_learning.tool_learning_core",
            importance=0.85,
            tags=["tool_learning", "result"],
        )
