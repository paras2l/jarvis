"""Route structured Jarvis commands to the appropriate execution backend."""
...
from jarvis.uci.command_parser import CommandAction, ParsedCommand
...
def _example_router() -> None:
    from jarvis.uci.command_parser import UnifiedCommandParser
