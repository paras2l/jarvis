"""Execution engine for the Jarvis Unified Command Interface."""
...
from jarvis.skills.skill_registry import SkillRegistry, SkillNotFoundError
from jarvis.system_bus.bus_core import SystemBus
from jarvis.uci.command_parser import ParsedCommand, UnifiedCommandParser
from jarvis.uci.command_router import CommandRoute, RoutingPlan, UnifiedCommandRouter
from jarvis.uci.device_manager import DeviceManager
...
class UnifiedCommandExecutionEngine:
    """Execute parsed Jarvis commands across skills, agents, and devices."""
