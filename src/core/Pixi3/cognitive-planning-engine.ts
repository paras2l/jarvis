...
import { PixiAgentRole, PixiPlan, PixiPlanStep, PixiStepKind } from './types'
...
class CognitivePlanningEngine {
  createPlan(goal: string): PixiPlan {
  ...
  private buildSteps(lowerGoal: string, originalGoal: string): PixiPlanStep[] {
