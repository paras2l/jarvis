...
import { PixiPlanStep } from './types'

class SkillExecutionEngine {
  async executeStep(step: PixiPlanStep, goal: string): Promise<{ success: boolean; output: string; data?: Record<string, unknown> }> {
