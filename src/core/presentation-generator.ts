/**
 * Presentation Generator â€” Feature #9
 *
 * Auto-generates full PowerPoint (.pptx) files from a single prompt.
 * Inspired by Pixi-MARK5's PowerPoint generator module.
 * Re-built for our stack using pptxgenjs (free npm package, no API needed).
 *
 * The agent can:
 *   - "Create a 20-slide deck about machine learning" â†’ full .pptx in seconds
...
// â”€â”€ PresentationGenerator â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class PresentationGenerator {
  ...
  async generate(
    ...
    console.log(`[PPT] ðŸŽ¨ Generating "${topic}" (${slideCount} slides)...`)
    ...
    console.log(`[PPT] âœ… Saved to ${filePath}`)
    return filePath
  }

  /**
   * Generate just the spec (slide outline) â€” for preview before generating.
   */
  async generateSpec(
    topic: string,
    slideCount: number,
...
- Return ONLY valid JSON, no markdown`
  ...
  // â”€â”€ Private: HTML Renderer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    li::before { content: 'â—†'; position: absolute; left: 0; color: #${t.accent}; font-size: 0.9rem; top: 15px; }
...
<body>
  <div class="title-bar">ðŸŽ¯ ${this.esc(spec.title)}</div>
  ${slideHtml}
  <div class="controls">
    <button onclick="changeSlide(-1)">â—€ Prev</button>
    <button onclick="changeSlide(1)">Next â–¶</button>
  ...
  private fallbackSpec(topic: string, count: number, theme: PresentationSpec['theme']): PresentationSpec {
    return {
      title: topic,
      subtitle: 'Generated by Pixi Agent',
      theme,
