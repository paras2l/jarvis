/**
 * Omni-Learning Agent — Database Layer
 * =====================================
...
export const db = {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // PHASE 9 — HUMANOID PROACTIVE DATA
  // ─────────────────────────────────────────────────────────────────────────
  ...
  settings: {
    async get(userTag = DEFAULT_USER): Promise<JarvisSettings | null> {
      const { data, error } = await supabase
      ...
      return (data as JarvisSettings | null) ?? null
    },

    async upsert(updates: Partial<JarvisSettings>, userTag = DEFAULT_USER): Promise<JarvisSettings | null> {
      const { data, error } = await supabase
        .from('jarvis_settings')
        .upsert(
          {
